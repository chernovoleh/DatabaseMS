...
public class DatabaseMSModelJRMPImpl implements DatabaseMSModelRMI {
	...
	public DatabaseMSModelJRMPImpl() throws RemoteException {
	...
	public static void main(String [] args) throws UnknownHostException {
		...
		try {
			DatabaseMSModelJRMPImpl model = new DatabaseMSModelJRMPImpl();
